...
const Footer = () => {
  return (
    <footer
      className="relative z-10 border-t border-white/5 mt-24"
      data-testid="footer"
    >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10">
          <div className="col-span-2">
            ...
            <p className="mt-5 text-sm text-slate-400 max-w-sm leading-relaxed">
              ...
              own your reputation, your socials, your zero-knowledge
              credentials.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-slate-400">
              ...
              <li>
                <Link to="/dijo.sol" className="hover:text-white transition">
                  Sample profile
                </Link>
              </li>
            </ul>
